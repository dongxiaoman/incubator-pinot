...
import org.apache.pinot.core.exception.PinotWebApplicationException;
...
public final class AccessControlUtils {
  ...
  public static void validatePermission(@Nullable String tableName, AccessType accessType,
    ...
    try {
      ...
      throw new PinotWebApplicationException(LOGGER, "Caught exception while validating permission for "
          + userMessage, Response.Status.INTERNAL_SERVER_ERROR, e);
    }

    throw new PinotWebApplicationException(LOGGER, "Permission is denied for " + userMessage,
