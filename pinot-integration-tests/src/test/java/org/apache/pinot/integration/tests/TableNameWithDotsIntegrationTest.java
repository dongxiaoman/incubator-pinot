...
public class TableNameWithDotsIntegrationTest extends BaseClusterIntegrationTestSet {
  ...
  public Map<String, Object> getDefaultControllerConfiguration() {
    Map<String, Object> properties = new HashMap<>(super.getDefaultControllerConfiguration());

    properties.put(CommonConstants.Helix.CONFIG_OF_ALLOW_TABLE_NAME_DOTS, true);
    return properties;
  }
